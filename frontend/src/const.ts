...
export const VENUE_ADDRESS =
  "Jl. Banda Aceh - Calang, Simpang Rima, Lamgeu-eu, Peukan Bada, Aceh Besar";
...
export const CALENDAR_URL = (() => {
  const params = new URLSearchParams({
    ...
    // UTC (8:00 AM WIB = 1:00 AM UTC)
    dates: "20260704T010000Z/20260704T080000Z",
    details: "Akad Nikah pukul 08.00 WIB\nResepsi pukul 11.00 WIB s/d selesai",
